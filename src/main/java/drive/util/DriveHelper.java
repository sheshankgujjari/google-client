...
public class DriveHelper {
    ...
    public static void getFirstTenAndPrint(Drive service) throws IOException {
    ...
    public static void createFile(Drive service) throws IOException {
    ...
    public static void searchFile(Drive service) throws IOException {
    ...
    public static void downloadFiles(Drive service, String fileId) throws IOException {
    ...
    public static void createFileInFolder(Drive service, String folderId) throws IOException {
        File fileMetadata = new File();
    ...
    public static void moveFilesFromOneFolderToAnother(Drive service) throws IOException {
...
// Move the file to the new folder
    ...
    public static void listApplicationDatFolder(Drive service) throws IOException {
    ...
    public static void createTeamDrives(Drive service) throws IOException {
